...
class CPUContextArm64 : public CPUContextImpl<CONTEXT_ARM64_STRUCT>
{
    typedef CPUContextImpl<CONTEXT_ARM64_STRUCT> Base;
public:
    CPUContextArm64() :
    ...
    explicit CPUContextArm64(const CONTEXT_ARM64_STRUCT &context) :
